...
<!-- Custom style -->
<link href="{{asset("packages/studiz/theme/admin-lte/css/app.css")}}" rel="stylesheet" type="text/css" />
...
<script src="{{asset("packages/studiz/theme/admin-lte/js/AdminLTE/demo.js")}}" type="text/javascript"></script>